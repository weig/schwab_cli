...
# The auth-subprocess timeout resolver was removed with the AuthMonitor:
# full auths now run in-process on the TokenManager's refresh thread
# (see tests/test_token_manager.py / tests/test_token_runtime.py).
